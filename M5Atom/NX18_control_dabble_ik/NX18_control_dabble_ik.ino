...
{
  float bs_s_ik[26][6]={
  {-FS0/2*(1-cos(pi*2/3)), H0, Dis+Ss*cos(pi/3), FS0/2*(1+cos(pi*2/3)), H0, Dis+Ss*cos(pi*2/3)},
  {-FS0/2*(1-cos(pi*5/6)), H0, Dis+Ss*cos(pi/6), FS0/2*(1+cos(pi*5/6)), H0, Dis+Ss*cos(pi*5/6)},
  {-FS0/2*(1-cos(pi)), H0, Dis+Ss*sin(pi/2), FS0/2*(1+cos(pi)), H0, Dis+Ss*cos(pi)},
  {-FS0/2*(1-cos(pi)), H0-Adj, Dis+Ss, 0, H0, Dis+Ss*cos(pi)},
  {-FS0*sin(pi/2)*2/3, H0-Up*sin(pi/6), Dis+Ss, 0, H0, Dis+Ss*cos(pi)},
  {-FS0*sin(pi/2)/3, H0-Up*sin(pi/3), Dis+Ss, 0, H0, Dis-Ss*sin(pi/2)},
  {0, H0-Up*sin(pi/2), Dis+Ss, 0, H0, Dis-Ss*sin(pi/2)},
  {FS1*sin(pi/2)/3, H0-Up*sin(pi/3), Dis+Ss+S2, 0, H0, Dis-Ss*sin(pi/2)},
  {FS1*sin(pi/2)*2/3, H0-Up*sin(pi/6), Dis+Ss+S2, 0, H0, Dis-Ss*sin(pi/2)},
  {FS1*sin(pi/2), H0-Adj, Dis+Ss*sin(pi/2), 0, H0, Dis-Ss*sin(pi/2)},
  {FS1/2*(1+cos(pi/6)), H0-Adj, Dis+Ss*cos(pi/6)+S2, -FS1/2*(1-cos(pi/6)), H0, Dis-Ss*sin(pi/3)},
  {FS1/2*(1+cos(pi/3)), H0-Adj, Dis+Ss*cos(pi/3)+S2, -FS1/2*(1-cos(pi/3)), H0, Dis-Ss*sin(pi/6)},
  {FS1/2*(1+cos(pi/2)), H0, Dis+S2/2, -FS1/2*(1-cos(pi/2)), H0, Dis+S2/2},
  {FS1/2*(1+cos(pi*2/3)), H0, Dis+Ss*cos(pi*2/3), -FS1/2*(1-cos(pi*2/3)), H0, Dis+Ss*cos(pi/3)+S2},
  {FS1/2*(1+cos(pi*5/6)), H0, Dis+Ss*cos(pi*5/6), -FS1/2*(1-cos(pi*5/6)), H0, Dis+Ss*cos(pi/6)+S2},
  {FS1/2*(1+cos(pi)), H0, Dis+Ss*cos(pi), -FS1/2*(1-cos(pi)), H0, Dis+Ss*sin(pi/2)+S2},
  {0, H0, Dis+Ss*cos(pi), -FS1/2*(1-cos(pi)), H0-Adj, Dis+Ss+S2},
  {0, H0, Dis+Ss*cos(pi), -FS1*sin(pi/2)*2/3, H0-Up*sin(pi/6), Dis+Ss+S2},
  {0, H0, Dis-Ss*sin(pi/2), -FS1*sin(pi/2)/3, H0-Up*sin(pi/3), Dis+Ss+S2},
  {0, H0, Dis-Ss*sin(pi/2), 0, H0-Up*sin(pi/2), Dis+Ss},
  {0, H0, Dis-Ss*sin(pi/2), FS1*sin(pi/2)/3, H0-Up*sin(pi/3), Dis+Ss},
  {0, H0, Dis-Ss*sin(pi/2), FS1*sin(pi/2)*2/3, H0-Up*sin(pi/6), Dis+Ss},
...
{
  float bs_s_ik[26][6]={
  {FS0/2*(1+cos(pi*2/3)), H0, Dis+Ss*cos(pi*2/3), -FS0/2*(1-cos(pi*2/3)), H0, Dis+Ss*cos(pi/3)},
  {FS0/2*(1+cos(pi*5/6)), H0, Dis+Ss*cos(pi*5/6), -FS0/2*(1-cos(pi*5/6)), H0, Dis+Ss*cos(pi/6)},
  {FS0/2*(1+cos(pi)), H0, Dis+Ss*cos(pi), -FS0/2*(1-cos(pi)), H0, Dis+Ss*sin(pi/2)},
  {0, H0, Dis+Ss*cos(pi), -FS0/2*(1-cos(pi)), H0-Adj, Dis+Ss},
  {0, H0, Dis+Ss*cos(pi), -FS0*sin(pi/2)*2/3, H0-Up*sin(pi/6), Dis+Ss},
  {0, H0, Dis-Ss*sin(pi/2), -FS0*sin(pi/2)/3, H0-Up*sin(pi/3), Dis+Ss},
  {0, H0, Dis-Ss*sin(pi/2),0, H0-Up*sin(pi/2), Dis+Ss},
  {0, H0, Dis-Ss*sin(pi/2), FS1*sin(pi/2)/3, H0-Up*sin(pi/3), Dis+Ss+S2},
  {0, H0, Dis-Ss*sin(pi/2), FS1*sin(pi/2)*2/3, H0-Up*sin(pi/6), Dis+Ss+S2},
  {0, H0, Dis-Ss*sin(pi/2), FS1*sin(pi/2), H0-Adj, Dis+Ss*sin(pi/2)},
  {-FS1/2*(1-cos(pi/6)), H0, Dis-Ss*sin(pi/3), FS1/2*(1+cos(pi/6)), H0-Adj, Dis+Ss*cos(pi/6)+S2},
  {-FS1/2*(1-cos(pi/3)), H0, Dis-Ss*sin(pi/6), FS1/2*(1+cos(pi/3)), H0-Adj, Dis+Ss*cos(pi/3)+S2},
  {-FS1/2*(1-cos(pi/2)), H0, Dis+S2/2, FS1/2*(1+cos(pi/2)), H0, Dis+S2/2},
  {-FS1/2*(1-cos(pi*2/3)), H0, Dis+Ss*cos(pi/3)+S2, FS1/2*(1+cos(pi*2/3)), H0, Dis+Ss*cos(pi*2/3)},
  {-FS1/2*(1-cos(pi*5/6)), H0, Dis+Ss*cos(pi/6)+S2, FS1/2*(1+cos(pi*5/6)), H0, Dis+Ss*cos(pi*5/6)},
  {-FS1/2*(1-cos(pi)), H0, Dis+Ss*sin(pi/2)+S2, FS1/2*(1+cos(pi)), H0, Dis+Ss*cos(pi)},
  {-FS1/2*(1-cos(pi)), H0-Adj, Dis+Ss+S2,0, H0, Dis+Ss*cos(pi)},
  {-FS1*sin(pi/2)*2/3, H0-Up*sin(pi/6), Dis+Ss+S2,0, H0, Dis+Ss*cos(pi)},
  {-FS1*sin(pi/2)/3, H0-Up*sin(pi/3), Dis+Ss+S2,0, H0, Dis-Ss*sin(pi/2)},
  {0, H0-Up*sin(pi/2), Dis+Ss,0, H0, Dis-Ss*sin(pi/2)},
  {FS1*sin(pi/2)/3, H0-Up*sin(pi/3), Dis+Ss,0, H0, Dis-Ss*sin(pi/2)},
  {FS1*sin(pi/2)*2/3, H0-Up*sin(pi/6), Dis+Ss,0, H0, Dis-Ss*sin(pi/2)},
  {FS1*sin(pi/2), H0-Adj, Dis+Ss*sin(pi/2),0, H0, Dis-Ss*sin(pi/2)},
...
void base_left_up_stop(float FS1, float S2)
{
  ...
  {0, H0, Dis-Ss*sin(pi/2), -FS1*sin(pi/2)/3, H0-Up*sin(pi/3), Dis+Ss+S2},
  {0, H0, Dis-Ss*sin(pi/2), 0, H0-Up*sin(pi/2), Dis+Ss},
  {0, H0, Dis-Ss*sin(pi/2), 0, H0-Up*sin(pi/3), Dis+Ss},
  {0, H0, Dis-Ss*sin(pi/2), 0, H0-Up*sin(pi/6), Dis+Ss},
...
void base_right_up_stop(float FS1, float S2)
{
  ...
  {-FS1*sin(pi/2)/3, H0-Up*sin(pi/3), Dis+Ss+S2,0, H0, Dis-Ss*sin(pi/2)},
  {0, H0-Up*sin(pi/2), Dis+Ss,0, H0, Dis-Ss*sin(pi/2)},
  {0, H0-Up*sin(pi/3), Dis+Ss,0, H0, Dis-Ss*sin(pi/2)},
  {0, H0-Up*sin(pi/6), Dis+Ss,0, H0, Dis-Ss*sin(pi/2)},
